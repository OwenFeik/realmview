...
async fn update_in_db(pool: &SqlitePool, user_id: i64, id: i64, title: String) -> anyhow::Result<()> {
...
async fn update_media(pool: SqlitePool, session_key: Option<String>, details: DetailsUpdate) -> Result<impl warp::Reply, Infallible> {
